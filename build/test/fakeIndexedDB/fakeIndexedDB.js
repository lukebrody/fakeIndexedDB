...
describe("fakeIndexedDB Tests", function() {
    ...
    it("can use deep index keypaths on undefined objects", function() {
        return __awaiter(void 0, void 0, void 0, function() {
            function idb() {
                return new Promise(function(resolve, reject) {
                    indexedDB.deleteDatabase(
                        ...
                        var openreq = indexedDB.open("deepPath");
                        openreq.onupgradeneeded = function(event) {
                            var db = event.target.result;
                            var test = db.createObjectStore("test");
            ...
            var indexedDB, db1, put;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        indexedDB = new FDBFactory_1.default();
                        return [4 /*yield*/, idb()];
                    case 1:
                        db1 = _a.sent();
                        put = db1

...
QUnit.test(
    "Adding data with external key - objectstore autoincrement",
    function(assert) {
        var done = assert.async();
        assert.expect(2);
        var data = { test: "test" };
...
QUnit.test(
    "Adding data with external key (increase autoincrement) - objectstore autoincrement",
    function(assert) {
        var done = assert.async();
        assert.expect(3);
        var data = { test: "test" };
                    ...
                    try {
                        ...
                        try {
                            ...
                            addRequest.onsuccess = function(e) {
                                ...
                                try {
                                    var addRequest2 = objectstore.add(
                                        data,
                                        key + 3,
                                    );
                                    addRequest2.onsuccess = function(e) {
                                        ...
                                        try {
                                            var addRequest3 = objectstore.add(
                                                data,
                                            );
                                            addRequest3.onsuccess = function(
                                                e,
                                            ) {
                                                equal(
                                                    e.target.result,
...
QUnit.test("Adding data with inline key - objectstore keyPath", function(
    assert,
) {
    var done = assert.async();
    assert.expect(2);
...
QUnit.test("Adding data with external key - objectstore keyPath", function(
    assert,
) {
    var done = assert.async();
    assert.expect(1);
...
QUnit.test(
    "Adding data with inline key - objectstore keyPath autoincrement",
    function(assert) {
        var done = assert.async();
        assert.expect(2);
...
QUnit.test(
    "Adding data with external key - objectstore keyPath autoincrement",
    function(assert) {
        var done = assert.async();
        assert.expect(1);
        var data = { test: "test" };
...
QUnit.test("Adding data with existing index key - unique index ", function(
    assert,
) {
    var done = assert.async();
    assert.expect(3);
...
QUnit.test(
    "Adding data with existing index key - unique multientry index ",
    function(assert) {
        var done = assert.async();
        assert.expect(3);
